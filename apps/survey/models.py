...
class SurveyUser(models.Model):
    ...
    def get_last_weekly_survey_date(self):
        try:
            ...
            cursor.execute("select max(timestamp) from pollster_results_intake where global_id = %s", [self.global_id])
        except:
...
class ParticipationTest(models.Model):
    ...
    class Meta:
        verbose_name_plural = 'Survey Participation Test'
